 ...
 *
 */
class TILTFIVE_API TiltFiveSpectatorController : 
	public ISpectatorScreenController, 
	public TSharedFromThis<TiltFiveSpectatorController, ESPMode::ThreadSafe>
{
public:
	TiltFiveSpectatorController(FTiltFiveXRBase* InHMDDevice);
	virtual ~TiltFiveSpectatorController() {}
